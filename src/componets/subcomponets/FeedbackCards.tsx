...
function FeedbackCards({ name, review, image }: CardProps) {
  return (
    <div className="flex flex-col max-w-[600px] items-center text-center bg-[#F3F3F3] px-[22px] py-6 mb-7 rounded-lg md:py-10 md:px-[40px] lg:items-start lg:text-start lg:rounded-2xl">
      <Image
        src={image}
        width={120}
        height={120}
